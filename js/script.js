...
// tramite un ciclo forEach prendiamo ogni indirizzo delle immagini dall'array
images.forEach(function(actualImage) {
    //Faccio in modo che ogni volta actualImage sia un oggetto diverso dell'array

    sliderElement.innerHTML +=`
    <section class="slide">
        <img src="./${actualImage.image}" alt="marvel spiderman">
        <div class="details">
            <div id="title">
                <h3>${actualImage.title}</h3>
            </div>
            <div id="text">
                ${actualImage.text}
            </div>
